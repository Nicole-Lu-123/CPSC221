...
public:
   ...
   * This function will call helper function buildTree.
   ...
   PNG* TreeHelper(PNG *im, int x, int y);
pair<int,int> findmidpoint(PNG* im,int k);
   /**
   ...
   PNG render();
void renderTree(Node* n, PNG *img);
   /*
   ...
   * You may want a recursive helper function for this one.
   ...
   void pruneTree(Node *n, double tol);
   bool tolCheck(Node *n, Node *subroot, double tol);
